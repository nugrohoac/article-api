...
func (_m *ArticleRepository) Fetch(ctx context.Context, filter kumparan_assessment.ArticleFilter) ([]kumparan_assessment.Article, error) {
...
func (_m *ArticleRepository) Store(ctx context.Context, article kumparan_assessment.Article) (kumparan_assessment.Article, error) {
